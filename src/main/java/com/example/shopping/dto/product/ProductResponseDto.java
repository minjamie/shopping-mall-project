...
public class ProductResponseDto {
    ...
    public static ProductResponseDto of(Product product, Brand brand, Image image, List<ProductOption> options){
        List<ProductResponseDto.ProductOptionDto> optionDtoList = options.stream()
